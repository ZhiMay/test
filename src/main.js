...
new Vue({
  ...
  template:"<div><button @click='stop'>停止</button><button @click='start'>开始</button><App :timeCount='timeCount' v-model='showTimerlock' :closable='closable'><span slot='close'>关闭</span></App></div>",
  components:{
    "App":App
  },
  methods:{
